...
},{"base64-js":"../../node_modules/base64-js/index.js","ieee754":"../../node_modules/ieee754/index.js","isarray":"../../node_modules/isarray/index.js","buffer":"../../node_modules/buffer/index.js"}],"../../node_modules/quill/dist/quill.js":[function(require,module,exports) {
var define;
...
},{"buffer":"../../node_modules/buffer/index.js"}],"../../node_modules/quill-emoji/dist/quill-emoji.js":[function(require,module,exports) {
var define;
...
},{"quill":"../../node_modules/quill/dist/quill.js"}],"../scripts/wysiwyg/icons.js":[function(require,module,exports) {
"use strict";
...
var iconsList = {
  redo: '<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<path d="M12.2934 9.80396L15.2184 6.48714L12.2934 3.17032C12.057 2.90199 12.0846 2.49451 12.3554 2.26015C12.6263 2.02601 13.0375 2.05353 13.2743 2.32165L16.5735 6.0629C16.788 6.30586 16.788 6.66861 16.5735 6.91157L13.2742 10.6528C13.1453 10.7986 12.9649 10.8735 12.7835 10.8735C12.6315 10.8735 12.479 10.821 12.3554 10.7141C12.0845 10.4798 12.0568 10.0723 12.2934 9.80396Z" ' + 'fill="currentColor"/>\n' + '<path d="M5.53414 5.84277H16.0832C16.4429 5.84277 16.7344 6.13151 16.7344 6.48782C16.7344 6.84409 16.4429 7.13286 16.0832 7.13286H5.53414C3.64292 7.13286 2.10439 8.65687 2.10439 10.5301C2.10439 12.4033 3.64292 13.9273 5.53414 13.9273H15.215C15.5746 13.9273 15.8661 14.2161 15.8661 14.5724C15.8661 14.9287 15.5746 15.2174 15.215 15.2174H5.53414C2.9251 15.2174 0.802051 13.1146 0.802051 10.5301C0.802051 7.94562 2.92488 5.84277 5.53414 5.84277Z" ' + 'fill="currentColor"/>\n' + '</svg>\n',
  emojis: '<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '\t\t\t\t\t\t<path d="M14.1597 3.06613C12.655 1.57572 10.6545 0.754883 8.52671 0.754883C6.39887 0.754883 4.3984 1.57572 2.89376 3.06613C1.38918 4.55661 0.560547 6.53825 0.560547 8.64606C0.560547 10.7539 1.38918 12.7355 2.89376 14.226C4.3984 15.7164 6.39887 16.5372 8.52671 16.5372C10.6545 16.5372 12.655 15.7164 14.1597 14.226C15.6642 12.7355 16.4929 10.7539 16.4929 8.64606C16.4929 6.53825 15.6642 4.55661 14.1597 3.06613ZM8.52671 15.3042C4.82048 15.3042 1.80526 12.3174 1.80526 8.64606C1.80526 4.97472 4.82048 1.98788 8.52671 1.98788C12.2329 1.98788 15.2482 4.97472 15.2482 8.64606C15.2482 12.3174 12.2329 15.3042 8.52671 15.3042Z" ' + 'fill="currentColor"/>\n' + '\t\t\t\t\t\t<path d="M12.0427 9.56426C12.0404 9.57086 11.8156 10.2309 11.2641 10.871C10.5623 11.6857 9.66636 12.0988 8.60126 12.0988C7.52847 12.0988 6.60365 11.6808 5.85253 10.8565C5.26378 10.2103 5.00388 9.54518 5.00208 9.54053L3.83594 9.97177C3.84901 10.0064 4.1637 10.8285 4.89435 11.6447C5.88224 12.7484 7.16408 13.3318 8.60126 13.3318C10.0455 13.3318 11.3055 12.7438 12.2451 11.6313C12.9396 10.8091 13.2149 9.98065 13.2263 9.94578L12.0427 9.56426Z" ' + 'fill="currentColor"/>\n' + '\t\t\t\t\t\t<path d="M5.78874 7.29311C6.33869 7.29311 6.78451 6.85148 6.78451 6.30671C6.78451 5.76194 6.33869 5.32031 5.78874 5.32031C5.23879 5.32031 4.79297 5.76194 4.79297 6.30671C4.79297 6.85148 5.23879 7.29311 5.78874 7.29311Z" ' + 'fill="currentColor"/>\n' + '\t\t\t\t\t\t<path d="M11.2653 7.29311C11.8152 7.29311 12.2611 6.85148 12.2611 6.30671C12.2611 5.76194 11.8152 5.32031 11.2653 5.32031C10.7154 5.32031 10.2695 5.76194 10.2695 6.30671C10.2695 6.85148 10.7154 7.29311 11.2653 7.29311Z" ' + 'fill="currentColor"/>\n' + '\t\t</svg>',
  link: '\t<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '\t\t\t\t\t\t<path d="M5.46351 14.1455C4.73451 14.8682 3.55185 14.8682 2.82282 14.1455C2.10478 13.4347 2.09333 12.2884 2.78897 11.5637L6.72428 7.66543C5.5072 7.34306 4.15765 7.63979 3.18469 8.5564L1.4349 10.2897C0.0435956 11.739 0.0664982 14.0317 1.50262 15.4533C2.96064 16.8986 5.32597 16.8986 6.784 15.4533L8.39733 13.8552C9.37521 12.8872 9.69759 11.5154 9.36466 10.2811L5.46351 14.1455Z" ' + 'fill="currentColor"/>\n' + '\t\t\t\t\t\t<path d="M15.2448 1.83899C13.8097 0.416394 11.4951 0.393707 10.0321 1.77192L8.28234 3.50523C7.35706 4.46907 7.05752 5.80591 7.38292 7.01151L11.3182 3.11323C12.0497 2.42414 13.207 2.43549 13.9245 3.14677C14.6541 3.86894 14.654 5.04044 13.9245 5.7626L10.0234 9.62703C11.2694 9.95683 12.6542 9.63751 13.6314 8.66881L15.2447 7.07066C16.7038 5.62636 16.7038 3.2833 15.2448 1.83899Z" ' + 'fill="currentColor"/>\n' + '\t\t\t\t\t\t<path d="M5.53533 11.4581C5.89985 11.8195 6.49118 11.8195 6.85566 11.4581L11.2129 7.14193C11.5777 6.78084 11.5777 6.19508 11.2129 5.83402C10.8541 5.47836 10.2755 5.47269 9.90973 5.81725L5.51837 10.1673C5.17057 10.5295 5.17629 11.1027 5.53533 11.4581Z" ' + 'fill="currentColor"/>\n' + '\t\t</svg>',
  image: '<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '\t\t\t\t\t\t<path d="M14.4811 3.00928H1.96289C1.02012 3.00928 0.255859 3.76635 0.255859 4.70024V12.5914C0.255859 13.5253 1.02012 14.2824 1.96289 14.2824H14.4811C15.4239 14.2824 16.1882 13.5253 16.1882 12.5914V4.70024C16.1882 3.76635 15.4239 3.00928 14.4811 3.00928ZM15.0501 9.53977L11.4694 5.99271C11.2472 5.77265 10.887 5.77265 10.6648 5.99271L5.94598 10.6671L4.07221 8.81094C3.85003 8.59088 3.48982 8.59088 3.26764 8.81094L1.39387 10.6671V4.70024C1.39387 4.38893 1.64863 4.13658 1.96289 4.13658H14.4811C14.7954 4.13658 15.0502 4.38893 15.0502 4.70024L15.0501 9.53977Z" ' + 'fill="currentColor"/>\n' + '\t\t\t\t\t\t<path d="M5.37696 8.64609C6.31973 8.64609 7.084 7.88902 7.084 6.95513C7.084 6.02123 6.31973 5.26416 5.37696 5.26416C4.43419 5.26416 3.66992 6.02123 3.66992 6.95513C3.66992 7.88902 4.43419 8.64609 5.37696 8.64609Z" ' + 'fill="currentColor"/>\n' + '\t\t</svg>',
  italic: '<svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<path d="M9.9092 1.74128H7.57629L4.81026 14.0712H6.92189V15.0576H0.947266V14.0712H3.28017L6.0462 1.74128H3.93458V0.754883H9.9092V1.74128Z" ' + 'fill="currentColor"/>\n' + '</svg>\n',
  blockquote: '<svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<path d="M15.3081 0.694336H10.3407C9.88969 0.694336 9.52367 1.05691 9.52367 1.50366V6.42433C9.52367 6.87109 9.88969 7.23365 10.3407 7.23365H12.7182C12.6871 8.52211 12.3848 9.55317 11.8129 10.3285C11.3619 10.9403 10.6789 11.447 9.76551 11.8468C9.34557 12.0297 9.16419 12.5218 9.36027 12.9329L9.94852 14.1631C10.1381 14.558 10.607 14.7312 11.0123 14.558C12.094 14.0951 13.0074 13.5091 13.7525 12.7969C14.661 11.9277 15.2836 10.9468 15.6202 9.85262C15.9568 8.75841 16.1251 7.26603 16.1251 5.37221V1.50366C16.1251 1.05693 15.7591 0.694336 15.3081 0.694336Z" ' + 'fill="currentColor"/>\n' + '<path d="M1.92603 14.5543C2.99468 14.093 3.9032 13.507 4.65322 12.7964C5.56991 11.9272 6.19574 10.9496 6.53235 9.86346C6.86895 8.77735 7.03724 7.28011 7.03724 5.37173V1.50317C7.03724 1.05642 6.67124 0.693848 6.22023 0.693848H1.2528C0.801806 0.693848 0.435785 1.05642 0.435785 1.50317V6.42384C0.435785 6.8706 0.801806 7.23317 1.2528 7.23317H3.6303C3.59926 8.52162 3.29696 9.55268 2.72505 10.328C2.27406 10.9399 1.59104 11.4465 0.67762 11.8463C0.257676 12.0292 0.0762995 12.5213 0.272382 12.9324L0.858997 14.1594C1.04856 14.5543 1.52079 14.7291 1.92603 14.5543Z" ' + 'fill="currentColor"/>\n' + '</svg>\n',
  bullet: '<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<rect x="6.83594" y="1.76855" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '<rect x="0.861328" y="0.782227" width="3.98308" height="3.94559" rx="1.97279" fill="currentColor"/>\n' + '<rect x="0.861328" y="6.70068" width="3.98308" height="3.94559" rx="1.97279" fill="currentColor"/>\n' + '<rect x="0.861328" y="12.6191" width="3.98308" height="3.94559" rx="1.97279" fill="currentColor"/>\n' + '<rect x="6.83594" y="7.68701" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '<rect x="6.83594" y="13.6055" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '</svg>\n' + '<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<path d="M8.73873 10.9094C8.59268 10.9094 8.45991 10.8568 8.3537 10.7516L5.03446 7.33205C4.83531 7.12162 4.8353 6.79282 5.04774 6.58239C5.26017 6.38511 5.5921 6.38511 5.80453 6.59554L8.73873 9.62049L11.6729 6.59554C11.8721 6.38511 12.2173 6.38511 12.4297 6.58239C12.6422 6.77967 12.6421 7.12162 12.443 7.33205L9.12376 10.7516C9.01755 10.8568 8.88478 10.9094 8.73873 10.9094Z" ' + 'fill="currentColor"/>\n' + '</svg>\n',
  ordered: '<svg width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<rect x="6.625" y="2.76855" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '<rect x="6.625" y="8.68701" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '<rect x="6.625" y="14.6055" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '<path d="M3.26791 5.7959H2.42123V2.53223L1.41049 2.8457V2.15723L3.17709 1.52441H3.26791V5.7959Z" fill="currentColor"/>\n' + '<path d="M4.1351 11.7144H1.21127V11.1343L2.59115 9.66357C2.7806 9.45654 2.92025 9.27588 3.0101 9.12158C3.10189 8.96729 3.14779 8.8208 3.14779 8.68213C3.14779 8.49268 3.09994 8.34424 3.00424 8.23682C2.90853 8.12744 2.77181 8.07275 2.59408 8.07275C2.40267 8.07275 2.25131 8.13916 2.13998 8.27197C2.0306 8.40283 1.97592 8.57568 1.97592 8.79053H1.12631C1.12631 8.53076 1.18783 8.29346 1.31088 8.07861C1.43588 7.86377 1.61166 7.6958 1.83822 7.57471C2.06478 7.45166 2.32162 7.39014 2.60873 7.39014C3.04818 7.39014 3.389 7.49561 3.63119 7.70654C3.87533 7.91748 3.9974 8.21533 3.9974 8.6001C3.9974 8.81104 3.94271 9.02588 3.83334 9.24463C3.72396 9.46338 3.53646 9.71826 3.27084 10.0093L2.30111 11.0317H4.1351V11.7144Z" ' + 'fill="currentColor"/>\n' + '<path d="M2.0726 15.125H2.52377C2.73861 15.125 2.89779 15.0713 3.00131 14.9639C3.10482 14.8564 3.15658 14.7139 3.15658 14.5361C3.15658 14.3643 3.10482 14.2305 3.00131 14.1348C2.89974 14.0391 2.75912 13.9912 2.57943 13.9912C2.41732 13.9912 2.28158 14.0361 2.1722 14.126C2.06283 14.2139 2.00814 14.3291 2.00814 14.4717H1.16146C1.16146 14.249 1.22103 14.0498 1.34017 13.874C1.46127 13.6963 1.62924 13.5576 1.84408 13.458C2.06088 13.3584 2.29916 13.3086 2.55892 13.3086C3.0101 13.3086 3.36361 13.417 3.61947 13.6338C3.87533 13.8486 4.00326 14.1455 4.00326 14.5244C4.00326 14.7197 3.94369 14.8994 3.82455 15.0635C3.70541 15.2275 3.54916 15.3535 3.3558 15.4414C3.59603 15.5273 3.77474 15.6562 3.89193 15.8281C4.01107 16 4.07064 16.2031 4.07064 16.4375C4.07064 16.8164 3.93197 17.1201 3.65463 17.3486C3.37924 17.5771 3.014 17.6914 2.55892 17.6914C2.13314 17.6914 1.78451 17.5791 1.51302 17.3545C1.24349 17.1299 1.10873 16.833 1.10873 16.4639H1.95541C1.95541 16.624 2.01498 16.7549 2.13412 16.8564C2.25521 16.958 2.40365 17.0088 2.57943 17.0088C2.7806 17.0088 2.93783 16.9561 3.05111 16.8506C3.16635 16.7432 3.22396 16.6016 3.22396 16.4258C3.22396 16 2.98959 15.7871 2.52084 15.7871H2.0726V15.125Z" ' + 'fill="currentColor"/>\n' + '</svg>\n' + '<svg width="9" height="5" viewBox="0 0 9 5" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<path d="M4.5317 4.90938C4.38565 4.90938 4.25288 4.85678 4.14666 4.75156L0.82743 1.33205C0.628276 1.12162 0.628273 0.792823 0.840704 0.582391C1.05314 0.385112 1.38507 0.385113 1.5975 0.595544L4.5317 3.62049L7.46592 0.595544C7.66507 0.385113 8.01026 0.385112 8.22269 0.582391C8.43513 0.779671 8.43511 1.12162 8.23595 1.33205L4.91673 4.75156C4.81052 4.85678 4.67775 4.90938 4.5317 4.90938Z" ' + 'fill="currentColor"/>\n' + '</svg>\n',
  indentMinus: '<svg width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<rect x="8.42188" y="0.769043" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '<rect x="9.41797" y="4.71484" width="8.96193" height="1.97279" fill="currentColor"/>\n' + '<path d="M3.95045 7.25597L3.95041 7.25593L3.94693 7.25938C3.83253 7.3727 3.77329 7.51911 3.77329 7.67537C3.77329 7.83163 3.83253 7.97804 3.94693 8.09136L3.9469 8.0914L3.95045 8.09478L6.10795 10.1498L6.10793 10.1498L6.11025 10.1519C6.33645 10.362 6.7097 10.3704 6.93494 10.1324L6.755 9.96208L6.93494 10.1324C7.14796 9.90728 7.15667 9.53443 6.91648 9.31001L5.19911 7.67537L6.91742 6.03984L6.91746 6.03988L6.921 6.03637C7.15155 5.808 7.15156 5.44726 6.93494 5.21837L6.93503 5.21828L6.9293 5.2126C6.69999 4.98546 6.33985 4.98558 6.11025 5.19881L6.11024 5.19879L6.10795 5.20097L3.95045 7.25597Z"' + 'fill="currentColor" stroke="currentColor" stroke-width="0.5"/>\n' + '<rect x="9.41797" y="8.66016" width="8.96193" height="1.97279" fill="currentColor"/>\n' + '<rect x="8.42188" y="12.606" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '</svg>\n',
  indentPlus: '<svg width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">\n' + '<rect x="8.27539" y="0.769043" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '<rect x="9.27148" y="4.71484" width="8.96193" height="1.97279" fill="currentColor"/>\n' + '<path d="M6.77026 7.25597L6.77029 7.25593L6.77377 7.25938C6.88817 7.3727 6.94741 7.51911 6.94741 7.67537C6.94741 7.83163 6.88817 7.97804 6.77377 8.09136L6.77381 8.0914L6.77026 8.09478L4.61275 10.1498L4.61277 10.1498L4.61045 10.1519C4.38425 10.362 4.01101 10.3704 3.78577 10.1324L3.9657 9.96208L3.78577 10.1324C3.57274 9.90728 3.56403 9.53443 3.80422 9.31001L5.52159 7.67537L3.80328 6.03984L3.80325 6.03988L3.7997 6.03637C3.56916 5.808 3.56914 5.44726 3.78577 5.21837L3.78567 5.21828L3.7914 5.2126C4.02071 4.98546 4.38085 4.98558 4.61045 5.19881L4.61047 5.19879L4.61276 5.20097L6.77026 7.25597Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/>\n' + '<rect x="9.27148" y="8.66016" width="8.96193" height="1.97279" fill="currentColor"/>\n' + '<rect x="8.27539" y="12.606" width="9.9577" height="1.97279" fill="currentColor"/>\n' + '</svg>\n'
};
exports.iconsList = iconsList;
},{}],"../scripts/wysiwyg/wysiwyg-comments.js":[function(require,module,exports) {
"use strict";
...
var replacementIcons = function replacementIcons() {
  var arrayIcons = ['redo', 'undo', 'link', 'image', 'bold', 'italic', 'blockquote', 'list', 'indent'];
  arrayIcons.forEach(function (element) {
    switch (true) {
      case element === 'undo':
        {
          icons[element] = _icons.iconsList.redo;
          break;
        }
      ...
      case element === 'list':
        {
          icons.ordered = _icons.iconsList.ordered;
          icons.bullet = _icons.iconsList.bullet;
          break;
        }

      case element === 'indent':
        {
          icons['-1'] = _icons.iconsList.indentMinus;
          icons['+1'] = _icons.iconsList.indentPlus;
          break;
        }

      default:
        {
          icons[element] = _icons.iconsList[element];
          break;
        }
    }
  });
...
replacementIcons();
var emojiIcon = _icons.iconsList.emojis;
var quill;
var container = document.getElementById('editor-comments');
var viewPort = window.matchMedia("(max-width: 700px)");

function toolbarGrid(viewPort) {
  if (viewPort.matches) {
    // If media query matches
    return [['undo', 'redo'], ['emoji', 'link', 'image']];
  }

  return [['undo', 'redo'], ['emoji', 'link', 'image'], ['bold', 'italic'], // toggled buttons
  [{
    'align': []
  }, 'blockquote'], [{
    'list': 'bullet'
...
var createEditor = function createEditor() {
  ...
  return new _quill.default(container, options);
};

var removePrevEditorElements = function removePrevEditorElements() {
  var toolbar = container.previousSibling;

  if (toolbar !== null && toolbar !== void 0 && toolbar.classList.contains('ql-toolbar')) {
    toolbar.remove();
  }
};
...
},{"quill/dist/quill":"../../node_modules/quill/dist/quill.js","quill-emoji":"../../node_modules/quill-emoji/dist/quill-emoji.js","./icons":"../scripts/wysiwyg/icons.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../scripts/wysiwyg/wysiwyg-comments.js"], null)
//# sourceMappingURL=/wysiwyg-comments.9c3e8a26.js.map
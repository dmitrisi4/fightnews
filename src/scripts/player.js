...
document.querySelectorAll('[data-async-frame]').forEach(player => {
	let dataSrc = player.dataset.src;
	let previewSrc = player.dataset.previewSrc;
	let srcdoc = `
		...
		<a href=${dataSrc}>
			<img src=${previewSrc} alt='Demo video'>
			<span>▶</span>
		</a>`
